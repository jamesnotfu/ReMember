...
public extension SCNNode {
    convenience init(withJSON profile: JSON, position: SCNVector3) {
        ...
        fullNameBubble.firstMaterial?.diffuse.contents = UIColor.white
        ...
        linkedInBubble.firstMaterial?.diffuse.contents = UIColor.white
        ...
        twitterBubble.firstMaterial?.diffuse.contents = UIColor.white
        ...
        fbBubble.firstMaterial?.diffuse.contents = UIColor.white
        ...
        phoneBubble.firstMaterial?.diffuse.contents = UIColor.white
